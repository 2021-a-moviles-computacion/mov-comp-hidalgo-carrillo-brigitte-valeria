...
class BFormularioColegio : AppCompatActivity() {
    ...
    fun editarColegio(colegio: Colegio) {
        ...
        val numAulas = findViewById<EditText>(R.id.it_num_aulas_cole).text.toString().toIntOrNull()
        if(numAulas != null) {
                ...
                colegio.idColegio?.let {
                    db.collection("colegio").document(it).update(aulasNuevo)
                        ...
                        .addOnSuccessListener {
                            ...
                            Toast.makeText(this, "¡Aulas colegio actualizadas!", Toast.LENGTH_SHORT)
                                .show()
            ...
            Toast.makeText(this, "Por favor, ingrese correctamente los datos", Toast.LENGTH_LONG)
        }
    }
    ...
    fun registrarColegio() {
        ...
        val distrito = findViewById<EditText>(R.id.it_distrito_cole).text.toString().toIntOrNull()
        val numAulas = findViewById<EditText>(R.id.it_num_aulas_cole).text.toString().toIntOrNull()
        val esFiscal = findViewById<Switch>(R.id.sw_esfiscal_cole).isChecked

        if (!nombreColegio.isNullOrEmpty() && distrito != null && numAulas != null) {
            ...
            Toast.makeText(
                this,
                "Por favor llene de manera correcta el formulario",
                Toast.LENGTH_LONG
            )
                .show()
        }
